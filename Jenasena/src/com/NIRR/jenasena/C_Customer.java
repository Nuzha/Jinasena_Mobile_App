...
public class C_Customer extends Activity implements OnItemClickListener{

	String[] list = { " Customer Proformance ", " Customer Balance "  };
	Integer[] images = { R.drawable.profermance,R.drawable.moneys};
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		switch (arg2) {
			...
			case 0:
				Intent p1 = new Intent(C_Customer.this, MainDelCustomerProformance.class);
				p1.putExtra(packagename, e1.getText());
				startActivity(p1);
				break;
			case 1:
				Intent p0 = new Intent(C_Customer.this, MainDelCustomerBillBalance.class);
