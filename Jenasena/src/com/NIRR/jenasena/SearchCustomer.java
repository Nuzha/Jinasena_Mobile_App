...
public class SearchCustomer extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
	   ...
	   // Log.e("commingtext",s1);
		...
		//create object out of the database and make the connection
	...
	private void displayListView(String getter){
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Intent p = new Intent(SearchCustomer.this, CustomerDataForDelear.class);
		...
		dataAdapter.setFilterQueryProvider(new FilterQueryProvider() {
			...
			public Cursor runQuery(CharSequence arg0) {
				// TODO Auto-generated method stub
				return dbHelper.fetchcustomerbynamelike(arg0.toString(),intent.getStringExtra(DelearMenu.packagename));
			}
