...
public class MainDelCustomerBillBalance extends Activity implements OnItemSelectedListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cdi_main_billbalance);
	  ...
	  //  String rep = sp.getSelectedItem().toString();
		...
		chart.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent p0 = new Intent(MainDelCustomerBillBalance.this, Chart_D_CustomerBallance.class);
				p0.putExtra(packagename, sp.getSelectedItem().toString());
				startActivity(p0);
