...
public class CustomersAcdnToRep extends Activity {
	TextView CATRrepId;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_customers_acdn_to_rep);
		
		CATRrepId  =(TextView)findViewById(R.id.tvCATRepId);
	...
	private void displayCusNames() {
		...
		final ListView CATRcusname = (ListView)findViewById(R.id.lvCATRcusnames);
		CATRcusname.setAdapter(dataAdapter1);
		CATRcusname.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int position,
					long arg3) {
				Cursor cursor =(Cursor)CATRcusname.getItemAtPosition(position);
				...
				switch (position) {
				case 0 :
					Intent p2 = new Intent(CustomersAcdnToRep.this,Selection.class);
				...
				default:
					Intent p3 = new Intent(CustomersAcdnToRep.this,Selection.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.customers_acdn_to_rep, menu);
		return true;
	}
